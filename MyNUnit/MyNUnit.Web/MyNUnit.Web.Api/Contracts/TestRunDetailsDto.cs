// <copyright file="TestRunDetailsDto.cs" company="Roman Levashev">
...
/// <summary>
/// Provides detailed results for a test run.
/// </summary>
public sealed class TestRunDetailsDto
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets per-assembly results.
    /// </summary>
    public List<AssemblyRunDto> Assemblies { get; set; } = new();
}
